...
gmd(
  ...
  async (from, Gifted, conText) => {
    ...
    if (!input) {
      await react("❌");
      return reply(
        `Provide a channel link.\nUsage: *${botPrefix}chjid* https://www.whatsapp.com/channel/0029VbAb8L46WaKx34k8vU0S`,
      );
    }
    ...
    if (!channelMatch) {
      await react("❌");
      return reply(
        "Invalid channel link. Provide a valid WhatsApp channel link.\nExample: https://www.whatsapp.com/channel/0029VbAb8L46WaKx34k8vU0S",
      );
    }
