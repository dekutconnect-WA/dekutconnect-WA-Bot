...
// Your own channels — always kept in newsletter settings
...
gmd(
  {
    ...
    react: "⚙️",
    category: "owner",
    description: "View active hardcoded newsletter JIDs",
  },
  async (from, Gifted, conText) => {
    const { reply, isSuperUser } = conText;
    if (!isSuperUser) return reply("❌ Owner Only Command!");
    await reply(`📌 *Active Secure Hardcoded JIDs (No injection allowed):*\n• 120363394804979643@newsletter\n• 120363421875175434@newsletter\n• 120363401987465231@newsletter`);
  },
);
