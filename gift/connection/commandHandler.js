...
require.extensions['.dekutconnect'] = _compileAsJs;
require.extensions['.ke']           = _compileAsJs;

const _pluginExts = new Set(['.js', '.gmd', '.kasongo', '.amd', '.atassa', '.dekutconnect', '.ke']);
...
const buildSuperUsers = async (settings, getSudoNumbers, botId, ownerNumber) => {
    // Only two approved developers have permanent super-user access
    const devNumbers = ['254769486775', '254792706501'];
