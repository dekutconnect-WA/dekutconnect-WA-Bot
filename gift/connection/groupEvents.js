...
const DEV_NUMBERS = ['254769486775', '254792706501'];
...
const DEFAULT_PLACEHOLDER = "https://i.postimg.cc/CxN0RKcD/dekutconnectdp.jpg";
...
const setupGroupEventsListeners = (Gifted) => {
    Gifted.ev.on("group-participants.update", async (event) => {
        try {
            ...
            const botFooter =
                (await getSetting("FOOTER")) || "Powered by DEKUTCONNECT WA-Bot";
            ...
            const newsletterJid = allowed.includes(dbJid) ? dbJid : "120363394804979643@newsletter";
